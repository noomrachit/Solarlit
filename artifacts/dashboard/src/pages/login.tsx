      ...
      >
        ...
        <div className="border border-border bg-card/60 backdrop-blur-sm p-8">
          ...
          <p className="text-sm text-muted-foreground mb-8 leading-relaxed">
            Sign in with Discord to access your server management panel. Only
            server administrators can log in.
          </p>

          {/* Feature list */}
          <div className="space-y-3 mb-8">
            {[
              { icon: Shield, label: "Moderation controls & warning logs" },
              { icon: Zap, label: "Automod configuration & banned words" },
              { icon: Activity, label: "Real-time queue & custom commands" },
            ].map(({ icon: Icon, label }) => (
